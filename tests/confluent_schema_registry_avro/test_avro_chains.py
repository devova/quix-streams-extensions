...
def test_from(mocked_schema_registry_during_serialization, schema_registry_client, schema, ctx):
    class From(avro.FromDict, BytesSerializer):
        ...

    serializer = From(schema_registry_client, schema)
...
def test_from_to(
    ...
    serializer = FromTo(schema_registry_client, schema, schema_registry_client)
