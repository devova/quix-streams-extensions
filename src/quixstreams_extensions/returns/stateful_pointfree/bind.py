...
def bind(
    ...
    .. code:: python
      ...
      >>> from quixstreams_extensions.returns.stateful_pointfree import bind
      >>> from returns.maybe import Maybe, Some, Nothing
      >>> from quixstreams import State

      >>> def example(argument: int, state: State) -> Maybe[int]:
    ...
    def factory(
        ...
        return container.bind(partial(function, state=state))
